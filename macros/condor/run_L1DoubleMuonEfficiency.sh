...
cp /afs/cern.ch/work/f/fernance/private/Scouting/2024Analysis/CMSSW_14_0_17/src/Analysis/MuonDST-Framework/macros/make_L1DoubleMuonEfficiency.py .
...
echo ${FLAGS}
python3 make_L1DoubleMuonEfficiency.py ${FLAGS}
rm make_L1DoubleMuonEfficiency.py
