...
cp /afs/cern.ch/work/f/fernance/private/Scouting/2025Analysis/CMSSW_15_0_5/src/MuonDST-Framework/*.txt .
...
cp -r /afs/cern.ch/work/f/fernance/private/Scouting/2025Analysis/CMSSW_15_0_5/src/MuonDST-Framework/macros .
echo ${FLAGS}
