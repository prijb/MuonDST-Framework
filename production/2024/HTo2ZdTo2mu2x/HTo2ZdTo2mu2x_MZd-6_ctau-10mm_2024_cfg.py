...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/EXO-Run3Summer22EEwmLHEGS-01411-fragment.py nevts:10'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-Run3Summer2024wmLHEGS-01411.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-Run3Summer2024wmLHEGS-01411_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            '1023:m0 = 6.0',
            '1023:mWidth = 1.9732999999999998e-14',
            '1023:tau0 = 10',
            '1023:isResonance = on',
            '1023:mayDecay = on',
            '1023:oneChannel = 1  0.21529 100 -2 2',
            '1023:addChannel = 1  0.2109 100 -4 4',
            '1023:addChannel = 1  0.1565 100 -13 13',
            '1023:addChannel = 1  0.1565 100 -11 11',
            '1023:addChannel = 1  0.1527 100 -15 15',
            '1023:addChannel = 1  0.05405 100 -3 3',
            '1023:addChannel = 1  0.05405 100 1 -1',
            '1023:addChannel = 1  0.0 100 -5 5',
            '1023:addChannel = 1  6.2629e-07 100 16 -16',
            '1023:addChannel = 1  6.2629e-07 100 14 -14',
            '1023:addChannel = 1  6.2629e-07 100 12 -12'
        ),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/20231108_fernance_DimuonScouting/LL_HAHM_MS_400_kappa_0p01_MZd_6p0_ctau_10_slc7_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.MuMuFilter+process.MuFilter)
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(12345)
